...
class FemaleShort extends StatefulWidget {
  @override
  _FemaleShortState createState() => _FemaleShortState();
}

class _FemaleShortState extends State<FemaleShort> {
                      ...
                      child: Row(
                        children: [
                          buildJacketContainer(
                            'assets/images/women/female_short_1.png',
                            (imagePath) {
                              setState(() {
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_short_2.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_short_3.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_short_4.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_short_5.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_short_6.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
    ...
    return Expanded(
      child: GestureDetector(
        onTap: () {
          ...
          } else if (assetPath == 'assets/images/jakcet.png') {
