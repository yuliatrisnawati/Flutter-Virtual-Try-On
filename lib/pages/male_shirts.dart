...
class MaleShirts extends StatefulWidget {
  @override
  _MaleShirtsState createState() => _MaleShirtsState();
}

class _MaleShirtsState extends State<MaleShirts> {
                      ...
                      child: Row(
                        children: [
                          buildJacketContainer(
                            'assets/images/men/male_tshirt_1.png',
                            (imagePath) {
                              setState(() {
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_tshirt_2.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_tshirt_3.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_tshirt_4.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_tshirt_5.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_tshirt_6.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      buildClothingContainer(
                          'assets/images/tshirt.png', Color(0xFFF6A0A0)),
                    ],
                  ),
                ),
                Container(
