...
class MalePants extends StatefulWidget {
  @override
  _MalePantsState createState() => _MalePantsState();
}

class _MalePantsState extends State<MalePants> {
                    ...
                    child: Stack(
                      children: [
                        ...
                        if (_selectedImagePath != null)
                          Positioned(
                            top: 250, // Adjust this value to move the image up
                      ...
                      child: Row(
                        children: [
                          buildJacketContainer(
                            'assets/images/men/male_pants_1.png',
                            (imagePath) {
                              setState(() {
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_pants_2.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_pants_3.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_pants_4.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_pants_5.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_pants_6.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      buildClothingContainer(
                          'assets/images/denim_shorts.png', Color(0xFFD7E4F2)),
                      buildClothingContainer(
                          'assets/images/jeans.png', Color(0xFFF6A0A0)),
                      buildClothingContainer(
                          'assets/images/sweater.png', Color(0xFFD7E4F2)),
                      buildClothingContainer(
                          'assets/images/tshirt.png', Color(0xFFFBCFBB)),
                    ],
                  ),
                ),
                Container(
  ...
  Widget buildClothingContainer(String assetPath, Color color) {
    return Expanded(
      child: GestureDetector(
        onTap: () {
          if (assetPath == 'assets/images/denim_shorts.png') {
            Navigator.pushNamed(context, '/maleshorts');
          } else if (assetPath == 'assets/images/jacket.png') {
            Navigator.pushNamed(context, '/malejacket');
          } else if (assetPath == 'assets/images/sweater.png') {
            Navigator.pushNamed(context, '/malesweatshirt');
          } else if (assetPath == 'assets/images/tshirt.png') {
            Navigator.pushNamed(context, '/maleshirts');
          }
        },
        child: Container(
