...
class MaleJacket extends StatefulWidget {
  @override
  _MaleJacketState createState() => _MaleJacketState();
}

class _MaleJacketState extends State<MaleJacket> {
                      ...
                      child: Row(
                        children: [
                          buildJacketContainer(
                            'assets/images/men/male_jacket_1.png',
                            (imagePath) {
                              setState(() {
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_jacket_2.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_jacket_3.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_jacket_4.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_jacket_5.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_jacket_6.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
