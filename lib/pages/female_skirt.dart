...
class FemaleSkirt extends StatefulWidget {
  @override
  _FemaleSkirtState createState() => _FemaleSkirtState();
}

class _FemaleSkirtState extends State<FemaleSkirt> {
                      ...
                      child: Row(
                        children: [
                          buildJacketContainer(
                            'assets/images/women/female_skirt_1.png',
                            (imagePath) {
                              setState(() {
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_skirt_2.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_skirt_3.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_skirt_4.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_skirt_5.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_skirt_6.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      buildClothingContainer(
                          'assets/images/skirt.png', Color(0xFF92C2F5)),
                      buildClothingContainer(
