...
class MaleSweatshirt extends StatefulWidget {
  @override
  _MaleSweatshirtState createState() => _MaleSweatshirtState();
}

class _MaleSweatshirtState extends State<MaleSweatshirt> {
                      ...
                      child: Row(
                        children: [
                          buildJacketContainer(
                            'assets/images/men/male_sweatshirt_1.png',
                            (imagePath) {
                              setState(() {
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_sweatshirt_2.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_sweatshirt_3.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_sweatshirt_4.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_sweatshirt_5.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/men/male_sweatshirt_6.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      buildClothingContainer(
                          'assets/images/sweater.png', Color(0xFF92C2F5)),
                      buildClothingContainer(
      ...
      child: GestureDetector(
        onTap: () {
          if (assetPath == 'assets/images/denim_shorts.png') {
            ...
            Navigator.pushNamed(context, '/malepants');
