...
class FemaleBlouse extends StatefulWidget {
  @override
  _FemaleBlouseState createState() => _FemaleBlouseState();
}

class _FemaleBlouseState extends State<FemaleBlouse> {
                      ...
                      child: Row(
                        children: [
                          buildJacketContainer(
                            'assets/images/women/female_blouse_1.png',
                            (imagePath) {
                              setState(() {
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_blouse_2.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_blouse_3.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_blouse_4.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_blouse_5.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                          ...
                          buildJacketContainer(
                            'assets/images/women/female_blouse_6.png',
                            (imagePath) {
                              setState(() {
                                _selectedImagePath = imagePath;
                              });
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      buildClothingContainer(
                          'assets/images/womens_blouse.png', Color(0xFFF6A0A0)),
                    ],
                  ),
                ),
                Container(
